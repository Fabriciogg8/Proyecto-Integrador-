...
const ListarCategorias = () => {
  ...
  const productosPorCategoria = [
    ...
    },
    {
      ...
      img: 'url_electricos.jpg',
      cantidad: 22,
    },
    {
      id: 8,
      name: 'Instrumentos de orquesta',
      img: 'url_orquesta.jpg',
      cantidad: 24,
    },
    {
      id: 9,
      name: 'Accesorios musicales',
      img: 'url_accesorios.jpg',
      cantidad: 26,
    },
  ]
                ...
                <li key={producto.id}>
                  <label>
                    <input
                      ...
                      onChange={() =>
                        handleCategoriaSeleccionada(producto.name)
                      }
                    />
