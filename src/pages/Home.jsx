...
const Home = () => {
  ...
  const categorias = [
    ...
    {  d: 6, name: 'Instrumentos de viento metal',img: 'url_viento_metal.jpg',},
  ...
  ? categorias.map(categoria => (
      <CardCategory
        key={categoria.id}  // Agregar esta línea
        name={categoria.name}
        img={categoria.img}
      />
    ))
  : null}
        ...
        <div className='container d-flex justify-content-center align-items-center h-100'>
          {/* Utilizar Resultados con la lista de instrumentos */}
          <Resultados productos={instrumentos} productosPorCategoria={categorias} />
        </div>
