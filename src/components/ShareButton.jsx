...
const ShareButton = ({ name, description, image }) => {
  ...
  const handleInstagramShare = () => {
    const caption = encodeURIComponent(
      `¡Mira este producto! ${state.desc} ${state.value}`,
    )
    ...
    if (
      ...
      alert(
        'No se puede compartir en Instagram desde un navegador web. Intenta desde la aplicación móvil.',
      )
    } else {
        ...
        <div>
          ...
          <div className='modal-content'>
            ...
            <input
              ...
              onChange={descCreate}
              placeholder='Inserte mensaje adicional'
            />
