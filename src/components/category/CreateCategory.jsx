...
const CreateCategory = () => {
  ...
  const handleSubmit = async event => {
    ...
    myHeaders.append(
      'Authorization',
      'Bearer eyJhbGciOiJIUzI1NiJ9.eyJmaXJzdE5hbWUiOiJBbGluYSIsImxhc3ROYW1lIjoiQ2FzYXMiLCJyb2xlIjoiQURNSU4iLCJzdWIiOiJhbGlAbWFpbC5jb20iLCJpYXQiOjE3MDE3MzAzMTYsImV4cCI6MTcwMTgxNjcxNn0.KPKoN4zM-CYAFvgaIVJP0UcFNk0V4ZOMU0xG341dHXQ',
    )
              ...
              <div className='card-body p-4 p-md-5'>
                ...
                <form onSubmit={handleSubmit} className='px-md-2'>
                  ...
                  {selectedFiles.length > 0 ? (
                    <p>Se ha subido {selectedFiles.length} imágen con éxito</p>
                  ) : (
